...
<head>
    ...
    <title>@yield('title', 'Delivery') | BYTE2BITE</title>
...
<div class="sidebar">
    <div class="sidebar-brand">
        ...
        <small style="color:#888;font-size:11px;">Delivery Panel</small>
    </div>
    <nav class="sidebar-nav">
        <a href="{{ route('delivery.dashboard') }}" class="{{ request()->routeIs('delivery.dashboard') ? 'active' : '' }}">
            <i class="fas fa-tachometer-alt"></i> Dashboard
        </a>
        <a href="{{ route('delivery.orders') }}" class="{{ request()->routeIs('delivery.orders*') ? 'active' : '' }}">
            <i class="fas fa-clipboard-list"></i> My Deliveries
        </a>
        <a href="{{ route('delivery.earnings') }}" class="{{ request()->routeIs('delivery.earnings') ? 'active' : '' }}">
            <i class="fas fa-wallet"></i> Earnings
        </a>
        <a href="{{ route('delivery.profile') }}" class="{{ request()->routeIs('delivery.profile') ? 'active' : '' }}">
